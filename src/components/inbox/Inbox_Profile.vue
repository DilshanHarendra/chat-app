<template>
  <nav v-if="userProfile" class="right-0 flex flex-col hidden pb-2 bg-white border-l border-gray-300 xl:block" style="width: 24rem">
    <div class="flex items-center justify-between w-full p-3">
      <button @click="$emit('hide-profile')" class="p-2 text-gray-500 rounded-full focus:outline-none hover:text-gray-600 hover:bg-gray-200">
    ...
    <div>
      <div class="flex justify-center mb-4">
        <button type="button" class="content-center block w-32 h-32 p-1 overflow-hidden text-center rounded-full focus:outline-none">
          <img class="content-center object-cover w-full h-full border-2 border-gray-200 rounded-full" :src="userProfile.picture" :alt="userProfile.name">
        </button>
      </div>

      <p class="text-lg font-semibold text-center text-gray-800">{{userProfile.name}}</p>
    ...
    <div class="flex items-center w-full px-3 mt-6">
      ...
      <div class="ml-4">
        <div class="mr-auto text-sm font-semibold text-gray-800">{{userProfile.greeting}}</div>
    ...
    <div>
      <div class="flex items-center w-full px-3 mt-4">
        ...
        <div>
          <div class="ml-4 mr-auto text-sm font-semibold text-gray-800">@{{userProfile.name}}</div>
